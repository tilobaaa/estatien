    ...
    <div className="px-4">
      <div className="flex flex-col gap-5 ">
        <div className="flex items-center">
          <img className="w-[2.125rem] h-[2.125rem]" src={logoSvg} alt="logo" />
      ...
      <div className="my-[3.12rem] grid grid-cols-2 gap-5">
        {/* Home */}
      ...
      <div className="flex flex-col gap-5 items-center -mx-4 bg-grey-10 px-4 py-5">
        ...
        <div className="flex flex-col gap-[0.62rem] text-sm leading-6 tracking-[-0.00525rem] font-medium text-center text-white">
